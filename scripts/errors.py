...
def safebooru_connection_error(
    ctx: tanjun.abc.Context, _: safebooru.SafebooruConnectionError
):
...
def safebooru_nothing_found(
    ctx: tanjun.abc.Context, error: safebooru.SafebooruNothingFound
):
...
# This dictionary is now much smaller as most errors are handled by Tanjun's
# built-in hooks and checks.
error_dictionary = {
