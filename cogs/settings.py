...
@tanjun.with_str_slash_option(
    ...
    choices={"Emoji in Names": "emona", "Links": "links"},
    default=None,
)
@tanjun.with_bool_slash_option(
    "active", "Set the filter directly to active or inactive.", default=None
)
@tanjun.as_slash_command("filterconf", "Configure content filters for this server.")
async def filterconf_command(
    ctx: tanjun.abc.Context, filter_type: str | None, active: bool | None
):
    """
    ...
    if not filter_type:
        ...
        all_known_filters = set(sqldata.FilterType)
